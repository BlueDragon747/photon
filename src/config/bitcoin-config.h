...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Photon Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Photon Core"
...
#define PACKAGE_BUGREPORT "https://github.com/BlueDragon747/photon/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Photon Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Photon Core 0.15.21"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "photon"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://github.com/BlueDragon747/photon"
